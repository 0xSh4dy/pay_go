...
function Transactions() {
  ...
  function SubmitForm() {
      ...
      const data = {amount:amount,title:title,mode:md,description:description,authToken:authToken}
  ...
  function AddNewBox() {
    return (
      <div className="newEntry mt-10">
        <div>
          <input type="text" placeholder='Debt/credit' className='p-2' onChange={(e)=>{setMode(e.target.value)}}/>
  ...
  function TransactionsFilter() {
    return (
      <div className="flex justify-around pt-2">
        ...
        />
          <input type="text" placeholder='Debt/credit' className='p-2' onChange={(e)=>{setSaveMode(e.target.value)}}/>

        <button className="trfilter bg-[#BDFA9A] rounded-2xl p-2" onClick={ApplyFilter}>
          Apply filter
        </button>
        <button
